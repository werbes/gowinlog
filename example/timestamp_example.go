...
func main() {
	fmt.Println("Starting timestamp-based filtering example...")
	...
	// Subscribe to the Application event log from now using timestamp-based filtering
	err = watcher.SubscribeFromNowWithTimestamp("Application", "*")
	if err != nil {
